...
@section('title', 'Laporan Hasil Perolehan')
  ...
  <div class="row">
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-body">
          <a href="{{route('laporan_hasil_perolehan.download')}}"><button type="button" class="btn btn-primary mb-4">Download PDF</button></a>
          <div class="row">
            <div class="col-md-12">
