...
@section('header', 'Tambah Pengawas')

@section('content')
    <div class="container">
        @include('message_info')
        <form id="form_id" role="form" action="{{route('pengawas.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" value="{{$user->no_urut + 1}}" placeholder="Alamat Customer" required readonly>
                    </div>
                </div>
