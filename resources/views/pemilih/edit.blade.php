...
@section('content')
    <div class="container">
        ...
        <form id="form_id" role="form" action="{{route('pemilih.update', $user->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="no_urut" class="form-control" value="{{$user->no_urut}}" placeholder="No Urut" required readonly>
                    </div>
                </div>

                <input type="hidden" name="no_urut_calon" value="{{$user->no_urut_calon}}">
