        ...
        <div class="row mx-5">
            <div class="col-md-4">
                <div class="form-group row">
                    <label class="col-form-label">Photo KTP Pemilih</label>
                    <div class="col-md-12">
                        <img src="{{asset($user->foto)}}" border="0" width="250" class="img-rounded" align="center"/>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-form-label">Photo Terbaru Pemilih</label>
                    <div class="col-md-12">
                        <img src="{{asset($user->foto_pengawas)}}" border="0" width="250" class="img-rounded" align="center"/>
                    </div>
                </div>
            </div>
            <div class="col-md-8">
